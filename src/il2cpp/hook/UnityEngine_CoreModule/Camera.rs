...
static mut SET_RECT_INJECTED_ADDR: usize = 0;
impl_addr_wrapper_fn!(set_rect_Injected, SET_RECT_INJECTED_ADDR, (), this: *mut Il2CppObject, value: *const Rect_t);

static mut RESET_ASPECT_ADDR: usize = 0;
impl_addr_wrapper_fn!(ResetAspect, RESET_ASPECT_ADDR, (), this: *mut Il2CppObject);
...
pub fn init(_UnityEngine_CoreModule: *const Il2CppImage) {
    unsafe {
        ...
        SET_RECT_INJECTED_ADDR = il2cpp_resolve_icall(c"UnityEngine.Camera::set_rect_Injected(UnityEngine.Rect&)".as_ptr());
        RESET_ASPECT_ADDR = il2cpp_resolve_icall(c"UnityEngine.Camera::ResetAspect()".as_ptr());
    }
